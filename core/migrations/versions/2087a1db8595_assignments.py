...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column(
            "grade", sa.Enum("A", "B", "C", "D", name="gradeenum"), nullable=True
        ),
        sa.Column(
            "state",
            sa.Enum("DRAFT", "SUBMITTED", name="assignmentstateenum"),
            nullable=True,
        ),
        sa.Column("created_at", sa.TIMESTAMP(timezone=True), nullable=False),
        sa.Column("updated_at", sa.TIMESTAMP(timezone=True), nullable=False),
    ...
    Assignment.submit(
        ...
        auth_principal=AuthPrincipal(
            user_id=student_1.user_id, student_id=student_1.id
        ),
    )
    ...
    Assignment.submit(
        ...
        auth_principal=AuthPrincipal(
            user_id=student_2.user_id, student_id=student_2.id
        ),
    )
