...
class Assignment(db.Model):
    ...
    def mark_grade(cls, _id, grade, auth_principal: AuthPrincipal):
        ...
        assertions.assert_valid(
            ...
            "assignments with DRAFT state cannot be graded",
        )
        ...
        if auth_principal.principal_id is None:  # The API is being called by a teacher
            assertions.assert_valid(
                ...
                "This assignment is to be graded by another teacher",
            )
    ...
    def get_assignments_by_teacher(cls, teacher_id):
        return cls.filter(
            cls.teacher_id == teacher_id, cls.state == AssignmentStateEnum.SUBMITTED
        ).all()
